...
var Component$1 = class Component2 {
  componentName;
  tagName;
  fullName;
  attributes;
...
var Directive$1 = class Directive2 {
  name;
  attributes;
  inputs;
  outputs;
...
var Component3 = class extends NodeWithI18n {
  componentName;
  tagName;
  fullName;
  attrs;
...
var _TreeBuilder = class __TreeBuilder {
  ...
  _getClosestElementLikeParent() {
    for (let i = this._containerStack.length - 1; i > -1; i--) {
      ...
      if (current instanceof Element2 || current instanceof Component3) {
        return current;
      }
    }
    return null;
...
var DynamicAstValidator = class _DynamicAstValidator extends RecursiveAstVisitor2 {
  dynamicNode = null;
...
function withFakeAsyncTestModule(fn2) {
  ...
  return fn2(fakeAsyncTestModule);
}
...
function fakeAsync(fn2, options) {
  return withFakeAsyncTestModule((v) => v.fakeAsync(fn2, options));
}
...
var TestBedCompiler = class {
  ...
  overridePipe(pipe2, override) {
    this.verifyNoStandaloneFlagOverrides(pipe2, override);
    this.resolvers.pipe.addOverride(pipe2, override);
    this.pendingPipes.add(pipe2);
  }
  ...
  queueType(type, moduleType) {
    ...
    const pipe2 = this.resolvers.pipe.resolve(type);
    if (pipe2 && !type.hasOwnProperty(NG_PIPE_DEF)) {
...
var TestBedImpl = class _TestBedImpl {
  ...
  static overridePipe(pipe2, override) {
    return _TestBedImpl.INSTANCE.overridePipe(pipe2, override);
  }
  ...
  static execute(tokens, fn2, context) {
    return _TestBedImpl.INSTANCE.execute(tokens, fn2, context);
  }
  static get platform() {
  ...
  overridePipe(pipe2, override) {
    ...
    this.compiler.overridePipe(pipe2, override);
    return this;
  }
  overrideProvider(token, provider) {
...
function inject2(tokens, fn2) {
  const testBed = TestBedImpl.INSTANCE;
  return function() {
    return testBed.execute(tokens, fn2, this);
  };
}
var InjectSetupWrapper = class {
  ...
  inject(tokens, fn2) {
    ...
    return function() {
      self._addModule();
      return inject2(tokens, fn2).call(this);
    };
  }
};
function withModule(moduleDef, fn2) {
  if (fn2) {
    return function() {
      const testBed = TestBedImpl.INSTANCE;
      if (moduleDef) {
...
//# sourceMappingURL=chunk-R6N2WNPS.js.map
