...
var CalendarWeekViewCurrentTimeMarkerComponent = class _CalendarWeekViewCurrentTimeMarkerComponent {
  constructor() {
    ...
    this.dateAdapter = inject(DateAdapter);
    this.zone = inject(NgZone);
    this.marker$ = this.zone.onStable.pipe((0, import_operators3.switchMap)(() => (0, import_rxjs3.interval)(60 * 1e3)), (0, import_operators3.startWith)(0), (0, import_operators3.switchMap)(() => this.columnDate$), (0, import_operators3.map)((columnDate) => {
